...
const hearingNotificationSchema = new mongoose.Schema(
  {
    ...
    claimantEmail: String, // ADD THIS neutralEmail
    timeAgo: String,
    error: String,
...
module.exports = mongoose.model("hearingNotification", hearingNotificationSchema);
